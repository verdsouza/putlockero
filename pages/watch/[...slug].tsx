    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: 'Home',
        item: 'https://putlockero.netlify.app',
      },
      {
        '@type': 'ListItem',
        position: 2,
  ...
  return (
    <div className="min-h-screen bg-miraj-black pt-20 md:pt-28 pb-20">
      {!isPaidUser && youtubeTrailerId ? (
        <>
          <SEO
            title={`${title} - Official Trailer | Watch Free on putlocker Movies Official`}
            ...
            type="video.other"
            path={router.asPath}
            keywords={[`${title} trailer`, `${title} official trailer`, `watch ${title} trailer`, `${title} movie trailer`, `${title} preview`, 'movie trailers', 'film trailers', 'putlocker Movies', 'free movie trailers', 'HD trailers']}
          />
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                publisher: {
                  '@type': 'Organization',
                  name: 'putlocker Movies Official',
                  logo: { '@type': 'ImageObject', url: 'https://putlockero.netlify.app/logo.png' },
                },
              }),
            }}
          />
        ...
        <SEO
          title={`${title} - Watch Free on putlocker Movies Official`}
